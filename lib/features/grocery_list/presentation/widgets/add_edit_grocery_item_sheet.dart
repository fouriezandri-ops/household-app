...
Future<void> showAddEditGroceryItemSheet(BuildContext context, {Item? existing}) {
...
class AddEditGroceryItemSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddEditGroceryItemSheet> createState() => _AddEditGroceryItemSheetState();
}

class _AddEditGroceryItemSheetState extends ConsumerState<AddEditGroceryItemSheet> {
  final _formKey = GlobalKey<FormState>();
  late final _titleController = TextEditingController(text: widget.existing?.title);
  late final _quantityController = TextEditingController(
    text: widget.existing?.details.quantity?.toString(),
  );
  late final _unitController = TextEditingController(text: widget.existing?.details.unit);
    ...
    return Padding(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text(
              widget.existing == null ? 'Add grocery item' : 'Edit grocery item',
